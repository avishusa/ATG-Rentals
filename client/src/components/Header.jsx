  ...
  return (
      ...
      <header className='bg-slate-200 shadow-md'>
        ...
        <h1 className='font-bold text-sm sm:text-xl flex flex-wrap'>
            <span className='text-slate-500'>ATG</span>
        ...
        <ul className='flex gap-4'>
          ...
          <Link to="/profile"> {currentUser ? (<img className='rounded-full w-7 h-7 object-cover' src={currentUser.profile_pic} alt='Profile'/>) :
