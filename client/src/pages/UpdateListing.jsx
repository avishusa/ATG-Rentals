...
function UpdateListing() {
    ...
    const handleSubmit = async(e) =>{
        ...
        try {
            ...
            if(+formData.regularPrice<+formData.discountPrice) return setError("Discounted price must be lowers than the regular price")
            setLoading(true);
            setError(false);
  ...
  return (
    ...
    <form onSubmit={handleSubmit} className='flex flex-col sm:flex-row gap-4'>
        <div className='flex flex-col gap-4 flex-1'>
            ...
            <div className='flex flex-wrap gap-6'>
                <div className='flex item-center gap-2'>
                    <input onChange={handleChange} value={formData.bedrooms} className='p-3 border-gray-300 rounded-lg' type='number' id='bedrooms' min='1' max='10' required/>
                    <p>Beds</p>
                </div>
                <div className='flex item-center gap-2'>
                    <input onChange={handleChange} value={formData.bathrooms} className='p-3 border-gray-300 rounded-lg' type='number' id='bathrooms' min='1' max='10' required/>
                    <p>Baths</p>
                </div>
                <div className='flex item-center gap-2'>
                    <input onChange={handleChange} value={formData.regularPrice} className='p-3 border-gray-300 rounded-lg' type='number' id='regularPrice' min='50' max='1000' required/>
                ...
                {formData.offer && (
                <div className='flex item-center gap-2'>
                    <input onChange={handleChange} value={formData.discountPrice} className='p-3 border-gray-300 rounded-lg' type='number' id='discountPrice' min='0' max='1000' required/>
                    <div className='flex flex-col items-center'>
        ...
        <button disabled={loading || uploading} type='submit' className='p-3 bg-slate-700 text-white rounded-lg uppercase hover:opacity-95 disabled:opacity-70'>{loading?"Processing":"Update Listing"}</button>
