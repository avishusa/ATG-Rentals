    ...
    <form className='flex flex-col sm:flex-row gap-4'>
        <div className='flex flex-col gap-4 flex-1'>
            ...
            <div className='flex flex-wrap gap-6'>
                ...
                <div className='flex item-center gap-2'>
                    <input className='p-3 border-gray-300 rounded-lg' type='number' id='beathrooms' min='1' max='10' required/>
                    <p>Baths</p>
                </div>
                <div className='flex item-center gap-2'>
        ...
        <button type='button' className='p-3 bg-slate-700 text-white rounded-lg uppercase hover:opacity-95 disabled:opacity-70'>Create Listing</button>
        </div>
    </form>
    </main>
  )
